...
if(isset($_GET['id'])) {
    $nasabahBsu->hapusBsu($_GET['id']);
    echo "<script> document.location='lihatbsu.php'</script>";
}
                    ...
                    <tbody>
                        ...
                        while ($tampil = mysqli_fetch_array($bsuData)) {
                            echo "<tr class='" . ($no % 2 == 1 ? 'ganjil' : 'genap') . "'>
                                ...
                                <td class='actions'><a class='edit' href='ubahbsu.php?id={$tampil['id']}'>Ubah</a></td>
                                <td class='actions2'><a class='trash' href='?id={$tampil['id']}' onclick=\"return confirm('Yakin Hapus Data?')\">Hapus</a></td>
                            </tr>";
                            $no++;
                        }
                        ?>
